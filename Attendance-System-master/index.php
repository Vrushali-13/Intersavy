    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">AWS Cloud based Online Attendance WebApp</a>
        </div>
    ...
    <table class="table table-bordered table-striped">
     ...
     <!-- FOOTER -->
      <footer style="background:; height:120%;">
        ...
        <p>&copy;       2023, DMI. &middot;  developed by  <a href="https://www.linkedin.com/in/nadeem-shaikh-023701278/">Nadeem Shaikh </p>
      </footer>
